"""Vina HPC adapter wrapper for engine-specific layout detection."""

from pathlib import Path
from typing import Dict, Optional, Union

from .engine_hpc_adapter import detect_vina_layout as _detect_vina_layout
from .engine_hpc_adapter import layout_to_cli_args as _layout_to_cli_args


def detect_vina_layout(project_dir: Union[str, Path]) -> Dict[str, Optional[Path]]:
    return _detect_vina_layout(project_dir)
