...
| --- | --- | --- | --- | --- | --- |
| `4-K_pneumoniae_/5-Post_Docking_Analysis` | `120000` | `4f1f79df14c6d15fc7c4e7ac4db10e383492579b` | deleted | Tracked symlink whose blob is a private absolute workstation target (redacted from active documentation). Unreferenced by code or documentation. Dangling in this checkout. Not a scientific result. | Restore original path: `git restore --source=8d4434d3a33eb83b1e12cad82944b02c83270e47 -- 4-K_pneumoniae_/5-Post_Docking_Analysis`. Inspect identity from Git history if authorized: `git cat-file blob 4f1f79df14c6d15fc7c4e7ac4db10e383492579b` |
